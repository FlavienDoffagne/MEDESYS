...
namespace MEDESYS.BUSINESS_OBJECTS
{
    ...
    public class Demandes_envoyees
    {
        ...
        public Demandes_envoyees()
        {

        }

        public Demandes_envoyees(string id_message, string texte_message, DateTime date_message, string xml, string id_ps_exp, string id_ps_dest, string id_demande)
        {
